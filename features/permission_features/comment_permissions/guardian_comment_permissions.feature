Feature: Comment permissions for a guardian

As a guardian, I can view any comment and edit and delete my own comments
...
Scenario: A comment created by someone else
  ...
  And I look at the post "A post"
  When I look at the posts first comment
  Then I should not see a edit link in the posts comments
  And I should not see a delete link in the posts comments