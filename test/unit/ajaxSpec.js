...
describe('ajax module', function() {
  ...
  describe('ajax', function() {
    ...
    describe('on success', function() {
      beforeEach(function() {
        httpBackend.expectPOST('/path', { data: 'val' }).respond(200, 'Some text');
    ...
    describe('on failure', function() {
      beforeEach(function() {
        httpBackend.expectPOST('/path', { data: 'val' }).respond(400);
    ...
    describe('on failure with a status of 0', function() {
      beforeEach(function() {
        httpBackend.expectPOST('/path', { data: 'val' }).respond(0);
    ...
    describe('on failure with a status of 422', function() {
      beforeEach(function() {
        httpBackend.expectPOST('/path', { data: 'val' }).respond(422, 'Some message');
        ajax({ url: '/path', method: 'POST', data: { data: 'val' }, error: 'Some error' });
        httpBackend.flush();
      });
